        ...
        <CardContent className="p-6">
          <div className="flex flex-col items-center justify-center space-y-3">
            ...
            {countdown !== null && countdown > 0 && (
              ...
              >
                <div className="text-sm text-indigo-600">Prepare your answer</div>
                <div className="text-4xl font-bold text-indigo-800">{countdown}</div>
              </motion.div>
            )}
            ...
            {audioBlob && !isRecording && !isProcessing && (
              ...
              >
                <Button
                  onClick={stopRecording}
                  size="lg"
                  className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-3 shadow-lg"
                >
                  Next Question
                </Button>
              </motion.div>
